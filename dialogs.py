...
from aiogram_dialog.widgets.kbd import Select, Button, Column, Multiselect, Next
...
async def on_clients_by_time_selected(c: CallbackQuery, widget: Any, dialog_manager: DialogManager):
...
clients_by_time_select_window = Window(
    ...
    getter=getinfo.get_clients_by_time,
